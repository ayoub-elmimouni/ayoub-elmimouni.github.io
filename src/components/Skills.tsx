...
export default function Skills() {
  ...
  const marketingSkills = [
    "Stratégie digitale", "Génération de leads", "Social Media Marketing", "Content Marketing", 
    "SEO/SEM", "Email Marketing", "Brand Strategy", "Market Research", "Analytics", "PPC Advertising"
  ]

  const designSkills = [
    "WordPress", "Shopify", "HTML/CSS/JS", "Adobe Photoshop", "Figma", "Blender", 
    "Montage vidéo", "UI/UX Design", "Logo Design", "Web Design", "Graphic Design"
  ]

  const analyticsSkills = [
    "HubSpot", "Salesforce", "Brevo", "Omnisend", "Make", "Google Analytics", 
    "Tag Manager", "Facebook Insights", "Google Ads", "Hootsuite", "Mailchimp"
  ]

  const languages = [
    { name: "Arabe", level: "Natif", percentage: 100, levelClass: "native" },
    { name: "Français", level: "C1", percentage: 90, levelClass: "advanced" },
    { name: "Anglais", level: "B2", percentage: 80, levelClass: "professional" },
    { name: "Espagnol", level: "Basique", percentage: 30, levelClass: "basic" },
    { name: "Allemand", level: "Débutant", percentage: 10, levelClass: "beginner" }
  ]
      ...
      <div className="max-width">
        ...
        <div className="skills-container grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
          ...
          <div className="skills-card marketing-card bg-white rounded-2xl p-8 shadow-lg transition-all duration-300 hover:-translate-y-3 hover:shadow-xl text-center border-3 border-transparent hover:border-red-500">
            ...
            <h3 className="text-2xl font-semibold text-gray-800 mb-6">Stratégie digitale</h3>
          ...
          <div className="skills-card design-card bg-white rounded-2xl p-8 shadow-lg transition-all duration-300 hover:-translate-y-3 hover:shadow-xl text-center border-3 border-transparent hover:border-blue-500">
            ...
            <h3 className="text-2xl font-semibold text-gray-800 mb-6">Création de sites web</h3>
            <div className="skills-list flex flex-wrap gap-3 justify-center">
          ...
          <div className="skills-card analytics-card bg-white rounded-2xl p-8 shadow-lg transition-all duration-300 hover:-translate-y-3 hover:shadow-xl text-center border-3 border-transparent hover:border-green-500">
            ...
            <h3 className="text-2xl font-semibold text-gray-800 mb-6">CRM & Marketing automation</h3>
            <div className="skills-list flex flex-wrap gap-3 justify-center">
